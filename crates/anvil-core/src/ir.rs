...
//!
//! Filled in by `anvil-parser`, consumed by `anvil-codegen`. See `docs/ir.md`
...
/// the user's original specifier in `original` so `anvil-codegen` can
...
///
/// Parser-agnostic: anvil-core stays free of any Oxc dependency. The
