//! Integration tests for `tsdi build` (M4).
//!
//! Materializes a small TypeScript project into a tempdir, runs the CLI,
//! and asserts that:
//! - the expected `<component>.tsdi.ts` file appears next to the source,
...
#[test]
fn build_emits_tsdi_file_next_to_component() {
    ...
    assert!(body.contains("AUTO-GENERATED by tsdi"), "body: {body}");
