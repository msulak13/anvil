...
Native binary launcher for [`@msulak/anvil`](https://github.com/msulak13/tsdi) — installs the right prebuilt CLI for your platform, exposes it as an `anvil` command, and provides a programmatic API for tooling that needs to invoke codegen (like [`@msulak/anvil-unplugin`](https://www.npmjs.com/package/@msulak/anvil-unplugin)).
...
- **No giant universal binary in the launcher** — `npm install @msulak/anvil-cli` downloads ~4MB, not ~25MB times five.
